...
if Mix.env() == :test do
  defmodule Mix.Tasks.GenerateAlertSummaryTable do
    ...
    defp here_and_now_os_notification_multiple_routes do
      scenario("Here + Now (OS Notification, Multiple Routes)", ~N[2026-06-10 12:23:00])
    ...
    defp here_and_now_rl_shuttle do
      scenario("Here + Now (RL/Shuttle/StopToDirection/LaterToday)", ~N[2026-06-15 08:58:00])
      |> subscription(route: "Red", stop: "place-jfk", direction: 0)
      |> alert(effect: :shuttle)
      |> active_period(~N[2026-06-15 03:00:00], ~N[2026-06-15 23:00:00])
      |> informed_entity(stops: ["place-andrw", "place-jfk", "place-shmnl", "place-nqncy"])
    end

    defp here_and_now_gl do
      scenario("Here + Now (GL/DirectionToStop/EndOfService)", ~N[2026-06-15 09:37:00])
      |> subscription(route: "line-Green", stop: "place-kencl", direction: 1)
      |> alert(effect: :service_change)
      |> active_period(~N[2026-06-15 03:00:00], ~N[2026-06-16 03:00:00])
    ...
    defp upcoming_tomorrow do
      scenario("Upcoming (Tomorrow)", ~N[2026-06-15 10:48:00])
      |> subscription(route: "Orange", stop: "place-sbmnl", direction: 0)
      |> alert(effect: :shuttle)
      |> active_period(~N[2026-06-16 10:00:00], ~N[2026-06-16 20:00:00])
      |> informed_entity(
    ...
    defp upcoming_today do
      scenario("Upcoming (Today)", ~N[2026-06-15 10:48:00])
      |> subscription(route: "Orange", stop: "place-sbmnl", direction: 0)
      |> alert(effect: :suspension)
      |> active_period(~N[2026-06-15 20:45:00], ~N[2026-06-16 03:00:00])
      |> informed_entity(stop: "place-sbmnl")
    end

    defp subway_delay do
      scenario("Subway Delay", ~N[2026-06-15 10:57:00])
      |> subscription(route: "Orange", stop: "place-rugg", direction: 0)
      |> alert(cause: :accident, effect: :delay, severity: 8, duration_certainty: :estimated)
      |> active_period(~N[2026-06-15 10:45:00], ~N[2026-06-15 12:57:00])
      |> informed_entity()
    end

    defp recurring_upcoming do
      scenario("Recurring (Upcoming)", ~N[2026-06-15 11:03:00])
      |> subscription(route: "Red", stop: "place-qamnl", direction: 0)
      |> alert(effect: :delay, cause: :single_tracking)
      |> active_period(~N[2026-06-15 21:00:00], ~N[2026-06-16 03:00:00])
      |> active_period(~N[2026-06-16 21:00:00], ~N[2026-06-17 03:00:00])
      |> active_period(~N[2026-06-17 21:00:00], ~N[2026-06-18 03:00:00])
      |> active_period(~N[2026-06-18 21:00:00], ~N[2026-06-19 03:00:00])
      |> active_period(~N[2026-06-19 21:00:00], ~N[2026-06-20 03:00:00])
      |> informed_entity(stops: ["place-qamnl", "place-brntn"])
    end

    defp recurring_now do
      scenario("Recurring (Now)", ~N[2026-06-15 21:03:00])
      |> subscription(route: "Red", stop: "place-qamnl", direction: 0)
      |> alert(effect: :delay, cause: :single_tracking)
      |> active_period(~N[2026-06-15 21:00:00], ~N[2026-06-16 03:00:00])
      |> active_period(~N[2026-06-16 21:00:00], ~N[2026-06-17 03:00:00])
    ...
    defp recurring_last_day do
      scenario("Recurring (Last Day)", ~N[2026-06-19 11:03:00])
      |> subscription(route: "Red", stop: "place-qamnl", direction: 0)
      |> alert(effect: :delay, cause: :single_tracking)
      |> active_period(~N[2026-06-15 21:00:00], ~N[2026-06-16 03:00:00])
      |> active_period(~N[2026-06-16 21:00:00], ~N[2026-06-17 03:00:00])
    ...
    defp recurring_some_days do
      scenario("Recurring (Some Days)", ~N[2026-06-15 21:03:00])
      |> subscription(route: "Red", stop: "place-qamnl", direction: 0)
      |> alert(effect: :delay, cause: :single_tracking)
      |> active_period(~N[2026-06-15 21:00:00], ~N[2026-06-16 03:00:00])
      |> active_period(~N[2026-06-17 21:00:00], ~N[2026-06-18 03:00:00])
    ...
    defp update do
      scenario("Update", ~N[2026-06-15 11:10:00])
      |> subscription(route: "line-Green", stop: "place-bland", direction: 0)
      |> alert(effect: :suspension, updated_at: t(~N[2026-06-15 11:09:00]))
      |> active_period(~N[2026-06-15 10:00:00], ~N[2026-06-19 20:00:00])
      |> informed_entity(route: "Green-B", stops: ["place-bland", "place-buest"])
      |> prior_delivered_notification()
    end

    defp all_clear do
      scenario("All Clear", ~N[2026-06-15 11:12:00])
      |> subscription(route: "line-Green", stop: "place-chill", direction: 0)
      |> alert(
        effect: :suspension,
        closed_timestamp: t(~N[2026-06-15 11:11:00]),
        last_push_notification_timestamp: t(~N[2026-06-15 11:11:00])
      )
      |> informed_entity(
        route: "Green-B",
        stops: [
    ...
    defp cr_cancel_one do
      scenario("Cancellation (CR)", ~N[2026-06-15 12:39:00])
      |> subscription(route: "CR-Worcester", stop: "place-WML-0214", direction: 1)
      |> alert(cause: :mechanical_issue, effect: :cancellation)
      |> active_period(~N[2026-06-15 18:30:00], ~N[2026-06-15 19:30:00])
      |> trip(id: "some_trip", stops: [{"place-WML-0214", ~N[2026-06-15 19:00:00]}])
      |> informed_entity(trip: "some_trip")
    end

    defp ferry_cancel_one do
      scenario("Cancellation (Ferry)", ~N[2026-06-15 09:10:00])
      |> subscription(route: "Boat-Lynn", stop: "Boat-Blossom", direction: 1)
      |> alert(cause: :weather, effect: :cancellation)
      |> active_period(~N[2026-06-15 08:50:00], ~N[2026-06-15 09:50:00])
      |> trip(id: "some_trip", stops: [{"Boat-Blossom", ~N[2026-06-15 09:20:00]}])
      |> informed_entity(trip: "some_trip")
    end

    defp ferry_cancel_two do
      scenario("Cancellation (Ferry, two trips)", ~N[2026-06-15 13:12:00])
      |> subscription(route: "Boat-Lynn", stop: "Boat-Blossom", direction: 1)
      |> alert(cause: :weather, effect: :cancellation)
      |> active_period(~N[2026-06-15 16:30:00], ~N[2026-06-15 19:00:00])
      |> trip(id: "some_trip", stops: [{"Boat-Blossom", ~N[2026-06-15 17:00:00]}])
      |> trip(id: "other_trip", stops: [{"Boat-Blossom", ~N[2026-06-15 18:30:00]}])
      |> informed_entity(trips: ["some_trip", "other_trip"])
    end

    defp ferry_cancel_all do
      scenario("Cancellation (Ferry, all trips)", ~N[2026-06-15 13:14:00])
      |> subscription(route: "Boat-Lynn", stop: "Boat-Blossom", direction: 1)
      |> alert(cause: :weather, effect: :cancellation)
      |> active_period(~N[2026-06-15 13:14:00], ~N[2026-06-16 03:00:00])
      |> informed_entity()
    end

    defp suspension_ol do
      scenario("Suspension (OL)", ~N[2026-06-16 13:28:00])
      |> subscription(route: "Orange", stop: "place-rugg", direction: 0)
      |> alert(effect: :suspension)
      |> active_period(~N[2026-06-15 13:00:00], ~N[2026-06-19 13:00:00])
      |> informed_entity(stops: ["place-rugg", "place-rcmnl", "place-jaksn"])
    end

    defp suspension_gl do
      scenario("Suspension (GL)", ~N[2026-06-16 13:29:00])
      |> subscription(route: "line-Green", stop: "place-clmnl", direction: 1)
      |> alert(effect: :suspension)
      |> active_period(~N[2026-06-15 13:00:00], ~N[2026-06-16 03:00:00])
      |> informed_entity(route: "Green-C")
    end

    defp shuttle_ol do
      scenario("Shuttle (OL)", ~N[2026-06-16 13:28:00])
      |> subscription(route: "Orange", stop: "place-rugg", direction: 0)
      |> alert(effect: :shuttle)
      |> active_period(~N[2026-06-15 13:00:00], ~N[2026-06-19 13:00:00])
      |> informed_entity(stops: ["place-rugg", "place-rcmnl", "place-jaksn"])
    ...
    defp shuttle_gl do
      scenario("Shuttle (GL)", ~N[2026-06-16 13:29:00])
      |> subscription(route: "line-Green", stop: "place-clmnl", direction: 1)
      |> alert(effect: :shuttle)
      |> active_period(~N[2026-06-15 13:00:00], ~N[2026-06-16 03:00:00])
      |> informed_entity(route: "Green-C")
    ...
    defp stop_closed_ol do
      scenario("Stop closed (OL)", ~N[2026-06-16 13:28:00])
      |> subscription(route: "Orange", stop: "place-rugg", direction: 0)
      |> alert(effect: :station_closure)
      |> active_period(~N[2026-06-15 13:00:00], ~N[2026-06-19 13:00:00])
      |> informed_entity(stops: ["place-rugg", "place-rcmnl", "place-jaksn"])
    ...
    defp stop_closed_gl do
      scenario("Stop closed (GL)", ~N[2026-06-16 13:29:00])
      |> subscription(route: "line-Green", stop: "place-clmnl", direction: 1)
      |> alert(effect: :station_closure)
      |> active_period(~N[2026-06-15 13:00:00], ~N[2026-06-16 03:00:00])
      |> informed_entity(route: "Green-C")
    ...
    defp service_change_ol do
      scenario("Service change (OL)", ~N[2026-06-16 13:28:00])
      |> subscription(route: "Orange", stop: "place-rugg", direction: 0)
      |> alert(effect: :service_change)
      |> active_period(~N[2026-06-15 13:00:00], ~N[2026-06-19 13:00:00])
      |> informed_entity(stops: ["place-rugg", "place-rcmnl", "place-jaksn"])
    ...
    defp service_change_gl do
      scenario("Service change (GL)", ~N[2026-06-16 13:29:00])
      |> subscription(route: "line-Green", stop: "place-clmnl", direction: 1)
      |> alert(effect: :service_change)
      |> active_period(~N[2026-06-15 13:00:00], ~N[2026-06-16 03:00:00])
      |> informed_entity(route: "Green-C")
    ...
    defp cr_trip_suspended_here do
      scenario("CR Trip Suspension", ~N[2026-06-15 12:00:00])
      |> subscription(route: "CR-Providence", stop: "place-rugg", direction: 0)
      |> alert(cause: :mechanical_issue, effect: :suspension)
      |> active_period(~N[2026-06-15 12:00:00], ~N[2026-06-15 12:30:00])
      |> trip(id: "some_trip", stops: [{"place-rugg", ~N[2026-06-15 12:13:00]}])
      |> informed_entity(trip: "some_trip")
    end

    defp cr_trip_suspended_downstream do
      scenario("CR Trip Suspension Downstream", ~N[2026-06-15 11:00:00])
      |> subscription(route: "CR-Fitchburg", stop: "place-FR-0201", direction: 1)
      |> alert(cause: :weather, effect: :suspension)
      |> active_period(~N[2026-06-15 11:00:00], ~N[2026-06-15 12:00:00])
      |> trip(id: "some_trip", stops: [{"place-FR-0201", ~N[2026-06-15 11:15:00]}])
      |> informed_entity(trip: "some_trip", stops: ["place-portr", "place-north"])
    end

    defp cr_trip_shuttle_here do
      scenario("CR Trip Shuttle", ~N[2026-06-15 12:00:00])
      |> subscription(route: "CR-Providence", stop: "place-rugg", direction: 0)
      |> alert(effect: :shuttle)
      |> active_period(~N[2026-06-15 12:00:00], ~N[2026-06-15 12:30:00])
      |> trip(id: "some_trip", stops: [{"place-rugg", ~N[2026-06-15 12:13:00]}])
    ...
    defp cr_trip_shuttle_downstream do
      scenario("CR Trip Shuttle Downstream", ~N[2026-06-15 11:00:00])
      |> subscription(route: "CR-Fitchburg", stop: "place-FR-0201", direction: 1)
      |> alert(effect: :shuttle)
      |> active_period(~N[2026-06-15 11:00:00], ~N[2026-06-15 12:00:00])
      |> trip(id: "some_trip", stops: [{"place-FR-0201", ~N[2026-06-15 11:15:00]}])
    ...
    defp cr_trip_station_bypass_here do
      scenario("CR Trip Station Bypass", ~N[2026-06-15 12:00:00])
      |> subscription(route: "CR-Providence", stop: "place-rugg", direction: 0)
      |> alert(effect: :station_closure)
      |> active_period(~N[2026-06-15 12:00:00], ~N[2026-06-15 12:30:00])
      |> trip(
        id: "some_trip",
        headsign: "Stoughton",
        stops: [{"place-rugg", ~N[2026-06-15 12:13:00]}]
      )
      |> informed_entity(trip: "some_trip", stops: ["place-bbsta", "place-rugg"])
    end

    defp cr_trip_station_bypass_downstream do
      scenario("CR Trip Station Bypass Downstream", ~N[2026-06-15 11:00:00])
      |> subscription(route: "CR-Fitchburg", stop: "place-FR-0201", direction: 1)
      |> alert(effect: :station_closure)
      |> active_period(~N[2026-06-15 11:00:00], ~N[2026-06-15 12:00:00])
      |> trip(
        ...
        stops: [{"place-FR-0201", ~N[2026-06-15 11:15:00]}]
      )
    ...
    defp active_period(%Scenario{} = scenario, ap_start, ap_end) do
      update_in(
        ...
        &(&1 ++ [%Alert.ActivePeriod{start: t(ap_start), end: t(ap_end)}])
      )
    end
    ...
    defp t(nil), do: nil
    defp t(%NaiveDateTime{} = t), do: DateTime.from_naive!(t, "America/New_York")
